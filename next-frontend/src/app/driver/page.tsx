    ...
    return(
        <div className="flex flex-1 w-full h-full">
            <div className="w-1/3 p-2 h-full">
                <h4 className="text-3xl text-constrast mb-2">Inicie uma rota</h4>
                <div className="flex flex-col">
                    <StartRouteForm>
                        <select 
                            id="route_id"
                            name="route_id" 
                            className="mb-2 p-2 border rounded bg-default text-constrast"
                        >
                            <option key="0" value="">
                                Selecione uma rota
                            </option>
                        ...
                        <button
                            className="bg-main text-primary p-2 rounded text-xl font-bold w-full"
                        >
                            Iniciar a viagem
                        </button>
                    </StartRouteForm>
